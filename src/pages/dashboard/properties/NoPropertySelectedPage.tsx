...
export function NoPropertySelectedPage() {
  ...
  function PropertiesGrid() {
    return (
      <Grid container className="h-full" spacing={-48}>
        {userProperties.map((propertyItem, index) => (
          <Grid key={index} item xs={3} className="flex justify-start">
  ...
  function PropertyItem({ property }: { property: Property }) {
    return (
      ...
      >
        <div className="flex lg:w-16rem lg:mb-6 justify-start text-left items-start">
          <div className="text-soft-black">
            <Typography
              variant="h6"
        ...
        <div className="flex text-soft-black justify-end pr-3 pb-2">
